...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Cum. Bşk. Adayı Ekleme  </h1>   
            <div align="right">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body" enctype="multipart/form-data">
                    <div class="form-group">
                        <div>
                            <img id="adayresim" src="../../img/noimage.png" width="150" height="130"></img>
                        </div>
                    </div>
                    <form id="uploadform">
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="aday_adsoyad"  placeholder="Aday ad soyad giriniz">
